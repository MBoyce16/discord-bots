...
@tree.command(name="Convert Crit", description="Convert crit to %Final Crit.")
async def convert_raw(interaction,
                      amount: T.Union[int, float]):
...
@tree.command(name="Convert ASPD", description="Convert ASPD to %Final ASPD.")
async def convert_raw(interaction,
                      amount: T.Union[int, float]):
...
@tree.command(name="Convert HASTE", description="Convert Haste or %Final Haste to CD Reduction or CT Reduction.")
async def convert_raw(interaction,
                      amount: T.Union[int, float],
                      stat:T.Literal['Haste', '%Final Haste'],
                      output: ['CT Reduction', 'CD Reduction']):
